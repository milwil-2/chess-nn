...
# Each frame contributes 12 piece planes; 6 meta planes cover current-position
# state (castling, en passant, side to move).  Total: 8×12 + 6 = 102 planes.
HISTORY_LENGTH = 8
...
def boards_to_tensor(boards: list) -> np.ndarray:
    """
    Encode up to HISTORY_LENGTH board states into a (102, 8, 8) tensor.
    ...
    """
    total_planes = HISTORY_LENGTH * 12 + 6
