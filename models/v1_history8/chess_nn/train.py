...
# Prevent MPS from reserving more than 70% of GPU memory — avoids OOM with larger model
...
DIRICHLET_EPS   = 0.15  # Fraction of target replaced with Dirichlet noise during training
